<div class="hoteles index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $hotele['Hotele']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $hotele['Hotele']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $hotele['Hotele']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $hotele['Hotele']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
