<div class="terapeutas index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $terapeuta['Terapeuta']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $terapeuta['Terapeuta']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
