<div class="tratamientos index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tratamiento['Tratamiento']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $tratamiento['Tratamiento']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
