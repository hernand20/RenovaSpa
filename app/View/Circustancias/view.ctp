<div class="circustancias view">
<h2><?php echo __('Circustancia'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($circustancia['Circustancia']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($circustancia['Circustancia']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Circustancia'), array('action' => 'edit', $circustancia['Circustancia']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Circustancia'), array('action' => 'delete', $circustancia['Circustancia']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $circustancia['Circustancia']['id']))); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($circustancia['Cliente'])): ?>
	...
	<?php foreach ($circustancia['Cliente'] as $cliente): ?>
		<tr>
